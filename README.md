...
Behaviour:
If the plug can not connect to its most recent SSID it goes into Access Point Mode. You can find its WiFi network which will have the same name as "#define NAME" and connect to it. 
...
To set calibration you will need a third-party reference device. Just enter the ratio between the reference and what you get from URL "S31/read" into corresponding fields.
